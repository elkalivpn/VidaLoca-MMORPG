...
export declare class PlayersService {
    ...
    getPlayerByUserId(userId: string): Promise<{
        vehicles: ({
            template: {
                id: string;
                name: string;
    ...
    updatePlayerLocation(userId: string, locationId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        displayName: string;
    ...
    addReputation(userId: string, reputation: number): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        displayName: string;
    ...
    setOnlineStatus(userId: string, isOnline: boolean): Promise<import("@prisma/client").Prisma.BatchPayload>;
    getAllPlayers(page?: number, limit?: number): Promise<{
        players: ({
            user: {
                email: string;
                username: string;
